...
JSON;
        ...
        $conversion = factory(Conversion::class)->create(['article_id' => $article]);
//        $conversion = factory(Conversion::class)->create()->each(function ($conversion) {$conversion->article()->save(factory(Article::class)->create());});
        ...
        $this->artisan(ProcessConversionSources::COMMAND);*/
    }
}
