...
func (cDB *CommerceElastic) Count(options AggregateOptions) (CountRowCollection, bool, error) {
	...
	search, _, err = cDB.DB.addGroupBy(search, cDB.getIndex(), options, nil, dateHistogramAgg)
	if err != nil {
		return nil, false, err
	}
...
func (cDB *CommerceElastic) Sum(options AggregateOptions) (SumRowCollection, bool, error) {
	...
	search, _, err = cDB.DB.addGroupBy(search, cDB.getIndex(), options, extras, dateHistogramAgg)
	if err != nil {
		return nil, false, err
	}
